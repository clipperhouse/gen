...
func TestDistinct(t *testing.T) {
	...
	if !sliceEqual(distinct1, ThingSlice{first, second, third, fourth}) {
...
func TestDistinctBy(t *testing.T) {
	...
	if !sliceEqual(distinctby1, ThingSlice{first, second, third}) {
...
func TestSortBy(t *testing.T) {
	...
	if !sliceEqual(sort1, ThingSlice{first, fourth, second, third, anotherThird}) {
...
func TestWhere(t *testing.T) {
	...
	w1 := ThingSlice{third, anotherThird}
...
func sliceEqual(a, b ThingSlice) bool {
	if len(a) != len(b) {
		return false
	}
	for i := 0; i < len(a); i++ {
...
func otherSliceEqual(a, b OtherSlice) bool {
	if len(a) != len(b) {
		return false
	}
	for i := 0; i < len(a); i++ {
